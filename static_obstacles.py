...
class Obstacle2:
    def __init__(self):
        ...
        self.cone = np.array([[5, 2]], dtype=float)  # 圆锥底面中心坐标
...
class Obstacle3:
    def __init__(self):
        self.obstacle = np.array(
            [[2, 2, 1], [2, 4, 1], [4, 2, 1], [4, 4, 1], [6, 2, 1], [6, 4, 1]],
            dtype=float,
        )  # 球障碍物坐标
        ...
        self.cone = np.array([], dtype=float)  # 圆锥底面中心坐标
...
class Obstacle4:
    def __init__(self):
        ...
        self.cone = np.array([[8, 5]], dtype=float)  # 圆锥底面中心坐标
        self.coneR = np.array([2], dtype=float)  # 圆锥底面圆半径
